...
int main() {
  ...
  std::cout << "  TAI − GPS = " << tai_gps_s << " s  (constant 19 s since 1980)\n\n";
  ...
  std::cout << "  JD → TT  → JD : "
            << std::abs(jd_from_tt.value()  - jd.value()) << "\n";
  std::cout << "  JD → TAI → JD : "
  ...
  std::cout << "  Julian centuries since J2000: "
  ...
  std::cout << "GPS +1 h → JD difference: "
            << std::fixed << std::setprecision(6)
            << (jd_plus1h.value() - jd_obs.value()) * 24.0
            << " h\n";
